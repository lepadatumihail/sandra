export function Testimonials() {
  ...
  return (
    <section className='bg-cream py-24 sm:py-32 relative overflow-hidden'>
      {/* Ambient glows */}
      <div className='absolute top-1/4 left-0 w-[30rem] h-[30rem] bg-blush/20 rounded-full blur-[100px] mix-blend-multiply pointer-events-none' />
      <div className='absolute bottom-1/4 right-0 w-[30rem] h-[30rem] bg-rose/15 rounded-full blur-[100px] mix-blend-multiply pointer-events-none' />

      <div className='max-w-6xl mx-auto px-6 relative z-10'>
        <div className='text-center mb-16 sm:mb-24'>
          <p className='font-handwriting text-4xl sm:text-5xl text-rose tracking-wider mb-4 rotate-[-2deg]'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12'>
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className='font-handwriting text-2xl text-rose/80 mb-6 rotate-[-2deg] group-hover:text-rose transition-colors duration-500'>
                {t.highlight}
              </p>
